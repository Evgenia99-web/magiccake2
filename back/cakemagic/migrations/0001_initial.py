# Generated by Django 4.2.1 on 2023-05-27 15:41

import cakemagic.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.ManyToManyField(blank=True, related_name='users_with_permission', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
            ...
            managers=[
                ('objects', cakemagic.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
